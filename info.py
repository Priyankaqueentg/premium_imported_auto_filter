...
BOT_USERNAME = environ.get("BOT_USERNAME", "Dbautofilterbot")
...
auth_channel = environ.get('AUTH_CHANNEL', 'https://t.me/+K6lKojnPsagzMzk1') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002284288836') # request channel id ( make sure bot is admin )
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/dbmoviesgroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/dbmovieschannel')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/dbtutorial')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Tctowner') #Support group link ( make sure bot is admin )
...
URL = "https://polite-octopus-ajb-8e01fc1e.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://polite-octopus-ajb-8e01fc1e.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://polite-octopus-ajb-8e01fc1e.koyeb.app/".format(FQDN)
else:
    URL = "https://polite-octopus-ajb-8e01fc1e.koyeb.app/".format(FQDN)
